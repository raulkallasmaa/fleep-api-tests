...
class FleepApi(FleepApiBase):
    ...
    def account_prepare_v2(self, notification_id=None,
            registration_code=None, registration_mail=None):
        """Check that notification is valid
        """
        return self._webapi_call('api/account/prepare/v2',
            notification_id = notification_id,
            registration_code = registration_code,
            registration_mail = registration_mail)

    def account_confirm_v2(self, notification_id,
            display_name, password, fleep_address):
        """Confirm account creation and proceed with it
        """
        return self._webapi_call('api/account/confirm/v2',
            notification_id = notification_id,
            display_name = display_name,
            password = password,
    ...
    def business_create(self, organisation_name):
        """Create org"""
        return self._webapi_call('api/business/create',
                organisation_name = organisation_name)

    def business_configure(self, organisation_id, add_account_ids=None, remove_account_ids=None,
		close_account_ids=None, add_admin_ids=None, remove_admin_ids=None,
		suspend_account_ids=None, activate_account_ids=None,
		organisation_name=None, add_domains=None, remove_domains=None):
        return self._webapi_call('api/business/configure', organisation_id,
                add_account_ids = add_account_ids,
                remove_account_ids = remove_account_ids,
		close_account_ids = close_account_ids,
		add_admin_ids = add_admin_ids,
		remove_admin_ids = remove_admin_ids,
                suspend_account_ids = suspend_account_ids,
                activate_account_ids = activate_account_ids,
                organisation_name = organisation_name,
                add_domains = add_domains,
                remove_domains = remove_domains)


    def business_sync(self, organisation_id, sync_version_nr=None):
        return self._webapi_call('api/business/sync', organisation_id,
                sync_version_nr = sync_version_nr)

    def business_sync_changelog(self, organisation_id, version_nr=None):
        return self._webapi_call('api/business/sync_changelog', organisation_id,
                version_nr = version_nr)

    def business_sync_conversations(self, organisation_id, sync_cursor=None):
        return self._webapi_call('api/business/sync_conversations', organisation_id,
                sync_cursor = sync_cursor)

    def business_get_conversations(self, organisation_id, conversation_ids):
        return self._webapi_call('api/business/sync_conversations', organisation_id,
              	conversation_ids = conversation_ids)

    def business_close(self, organisation_id):
        return self._webapi_call('api/business/close', organisation_id)

    ##
    ## business team
    ##

    def business_create_team(self, organisation_id,
            team_name=None, emails=None, account_ids=None,
            conversations=None, is_autojoin=None):
        return self._webapi_call('api/business/create_team', organisation_id,
		team_name = team_name,
                emails = emails,
    ...
    def business_store_team(self, organisation_id,
            team_id=None, team_name=None,
	    add_emails=None, remove_emails=None, disclose_emails=None,
            add_conversations=None, remove_conversations=None,
            add_account_ids=None, remove_account_ids=None, disclose_account_ids=None,
            is_autojoin=None, is_managed=None, is_deleted=None):
        return self._webapi_call('api/business/store_team', organisation_id,
                team_id = team_id,
                team_name = team_name,
                ...
                add_account_ids = add_account_ids,
                remove_account_ids = remove_account_ids,
                disclose_account_ids = disclose_account_ids,
                is_autojoin = is_autojoin,
                is_managed = is_managed,
                is_deleted = is_deleted)

    def business_sync_teams(self, organisation_id, sync_cursor=None):
        return self._webapi_call('api/business/sync_teams', organisation_id,
                sync_cursor = sync_cursor)

    def business_get_teams(self, organisation_id, team_ids):
        return self._webapi_call('api/business/sync_teams', organisation_id,
                team_ids = team_ids)
    ...
    def conversation_store(self, conversation_id,
	    read_message_nr = None, topic = None,
	    labels = None, label_ids = None,
            mk_alert_level = None, snooze_interval = None,
            add_emails = None, remove_emails = None,
            disclose_emails = None,
            add_account_ids = None, remove_account_ids = None,
            disclose_account_ids = None,
            hide_message_nr = None, is_deleted = None, can_post = None,
            is_deleted_by_admin = None, is_autojoin = None,
            is_disclose = None,
            is_url_preview_disabled = None, is_list = None,
            add_team_ids = None, remove_team_ids = None,
            is_managed = None, admins = None,
            from_message_nr = None):

        return self._webapi_call('api/conversation/store', conversation_id,
                read_message_nr = read_message_nr, topic = topic,
                labels = labels, label_ids = label_ids,
                mk_alert_level = mk_alert_level, snooze_interval = snooze_interval,
                add_emails = add_emails, remove_emails = remove_emails,
                disclose_emails = disclose_emails,
                add_account_ids = add_account_ids, remove_account_ids = remove_account_ids,
                disclose_account_ids = disclose_account_ids,
                hide_message_nr = hide_message_nr, is_deleted = is_deleted, can_post = can_post,
                is_deleted_by_admin = is_deleted_by_admin, is_autojoin = is_autojoin,
                is_disclose = is_disclose,
                is_url_preview_disabled = is_url_preview_disabled, is_list = is_list,
                add_team_ids = add_team_ids, remove_team_ids = remove_team_ids,
                is_managed = is_managed, admins = admins,
                from_message_nr = from_message_nr)
    ...
    def message_store(self, conversation_id, message_nr = None, message = None,
            ...
            add_reactions = None, del_reactions = None):
    ...
    def team_create(self, team_name,
            emails = None, account_ids = None, conversations = None,
            is_autojoin = None, is_managed = None):
        """Create team
        """
    ...
    def team_sync(self, team_id, conversation_id):
        """Sync team state for displaying in conversation
        """
        return self._webapi_call('api/team/sync', team_id, conversation_id = conversation_id)
