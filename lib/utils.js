...
// returns callback for .then() that runs over seq
// usage:
//   .then(sequenceRunner([f1, f2]))
function sequenceRunner(seq) {
    return function sequenceRunnerCallback() {
        return runSequenceAsync(seq);
    };
}
