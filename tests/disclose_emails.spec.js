...
test('conversation disclose and disclose all in managed conversation using emails parameter', function () {
    ...
    return thenSequence([
        ...
        () => client.api_call("api/conversation/disclose_all/" + client.getConvId(conv_topic), {emails: UC.jon.email}),
...
test('conversation disclose and disclose all in free conversation using emails parameter', function () {
    ...
    return thenSequence([
        ...
        () => client.api_call("api/conversation/disclose_all/" + client.getConvId(conv_topic), {emails: UC.jil.email}),
