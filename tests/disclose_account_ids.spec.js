...
let org_conv_create = {
    ...
    "autojoin_url": "<autojoin:managedConvDiscloseUsingAccountIDs>",
    "cmail": "<cmail:managedConvDiscloseUsingAccountIDs>",
    "conversation_id": "<conv:managedConvDiscloseUsingAccountIDs>",
    ...
    "organisation_id": "<org:orgDiscloseUsingAccountIDs>",
    "teams": [],
    "topic": "managedConvDiscloseUsingAccountIDs",
    }],
};

let added_meg_to_managed_conv = {
    "stream": [{
    "admins": [
    "<account:Bob Marley>",
    ],
...
let added_don_to_free_conv = {
    "header": {
    "admins": [],
    "can_post": true,
    "conversation_id": "<conv:freeConvDiscloseUsingAccountIDs>",
    "creator_id": "<account:Bob Marley>",
    "default_members": [],
    "export_files": [],
    "export_progress": "1",
    ...
    "snooze_time": 0,
    "teams": [],
    "topic": "freeConvDiscloseUsingAccountIDs",
    "topic_message_nr": 1,
    "unread_count": 0,
    },
    "stream": [{
...
test('conversation disclose and disclose all in managed conversation using account ids parameter', function () {
    let client = UC.bob;
    let conv_topic = 'managedConvDiscloseUsingAccountIDs';
    let org_name = 'orgDiscloseUsingAccountIDs';
    ...
    return thenSequence([
        ...
        () => client.api_call("api/business/configure/" + client.getOrgId(org_name), {add_account_ids: [UC.meg.account_id]}),
        // meg joins the org
        ...
        (res) => expect(UC.clean(res)).toMatchObject(org_conv_create),
        ...
        (res) => expect(UC.clean(res)).toMatchObject(added_meg_to_managed_conv),
        // check that meg doesn't see the 3 messages before disclose
        () => UC.meg.poll_filter({mk_rec_type: 'conv', topic: conv_topic}),
        () => UC.meg.matchStream({mk_rec_type: 'message', message: 'message1'}),
        (res) => expect(UC.clean(res)).toEqual(null),
        () => UC.meg.matchStream({mk_rec_type: 'message', message: 'message2'}),
        (res) => expect(UC.clean(res)).toEqual(null),
        () => UC.meg.matchStream({mk_rec_type: 'message', message: 'message3'}),
        (res) => expect(UC.clean(res)).toEqual(null),
        ...
        () => UC.meg.poll_filter({mk_rec_type: 'message', message: /message1/}),
        () => UC.meg.getMessage(/message1/),
        ...
        () => client.api_call("api/business/configure/" + client.getOrgId(org_name), {add_account_ids: [UC.jon.account_id]}),
        // jon joins the org
        ...
        (res) => expect(UC.clean(res)).toMatchObject(added_jon_to_managed_conv),
        // check that jon doesn't see the 3 messages before disclose all
        () => UC.jon.poll_filter({mk_rec_type: 'conv', topic: conv_topic}),
        () => UC.jon.matchStream({mk_rec_type: 'message', message: 'message1'}),
        (res) => expect(UC.clean(res)).toEqual(null),
        () => UC.jon.matchStream({mk_rec_type: 'message', message: 'message2'}),
        (res) => expect(UC.clean(res)).toEqual(null),
        () => UC.jon.matchStream({mk_rec_type: 'message', message: 'message3'}),
        (res) => expect(UC.clean(res)).toEqual(null),
        // disclose all the conv messages to jon
        () => client.api_call("api/conversation/disclose_all/" + client.getConvId(conv_topic), {account_ids: [UC.jon.account_id]}),
        // check that jon now sees the 3 messages
        () => UC.jon.poll_filter({mk_rec_type: 'message', message: /message1/}),
        () => UC.jon.getMessage(/message1/),
        (res) => expect(UC.clean(res)).toMatchObject({
            "account_id": "<account:Bob Marley>",
            "conversation_id": "<conv:managedConvDiscloseUsingAccountIDs>",
            "inbox_nr": 1,
...
test('conversation disclose and disclose all in free conversation using account ids parameter', function () {
    let client = UC.bob;
    let conv_topic = 'freeConvDiscloseUsingAccountIDs';
    ...
    return thenSequence([
        ...
        () => client.api_call("api/message/store/" + client.getConvId(conv_topic), {message: 'msg3'}),
        ...
        (res) => expect(UC.clean(res)).toMatchObject(added_don_to_free_conv),
        // check that don doesn't see the 3 messages before disclose
        ...
        (res) => expect(UC.clean(res)).toEqual(null),
        () => UC.don.matchStream({mk_rec_type: 'message', message: /msg3/}),
        (res) => expect(UC.clean(res)).toEqual(null),
        ...
        () => UC.don.poll_filter({mk_rec_type: 'message', message: /msg1/}),
        ...
        (res) => expect(UC.clean(res)).toMatchObject(added_jil_to_free_conv),
        // check that jil doesn't see the 3 messages before disclose all
        ...
        (res) => expect(UC.clean(res)).toEqual(null),
        () => UC.jil.matchStream({mk_rec_type: 'message', message: /msg3/}),
        (res) => expect(UC.clean(res)).toEqual(null),
        // disclose all the conv messages to jil
        () => client.api_call("api/conversation/disclose_all/" + client.getConvId(conv_topic), {account_ids: [UC.jil.account_id]}),
        // check that jil now sees the 3 messages
        () => UC.jil.poll_filter({mk_rec_type: 'message', message: /msg1/}),
